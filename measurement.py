...
for pair in POSE_PAIRS:
    ...
    if points[2] and points[4]:
        ...
        D = dist.euclidean(points[2], points[4])/height
        (mX, mY) = midpoint(points[2], points[4])
        cv2.putText(frame, "{:.1f} in".format(D), (int(mX), int(mY - 10)), cv2.FONT_HERSHEY_SIMPLEX, 0.55, (0,0, 255), 2)
    ...
    if points[5] and points[7]:
        ...
        D = dist.euclidean(points[5], points[7])/height
    ...
    if points[8] and points[10]:
        ...
        D = dist.euclidean(points[8], points[10])/height
    ...
    if points[11] and points[13]:
        ...
        D = dist.euclidean(points[11], points[7])/height
    ...
    if points[2] and points[11]:
        ...
        D = dist.euclidean(points[2], points[11])/height
        (mX, mY) = midpoint(points[2], points[11])
        cv2.putText(frame, "{:.1f} in".format(D), (int(mX), int(mY - 10)), cv2.FONT_HERSHEY_SIMPLEX, 0.55, (255,0, 0), 2)
